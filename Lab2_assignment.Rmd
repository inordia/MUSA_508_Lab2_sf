...
acs_vars <- c("B01003_001","B01001B_001","B08201_002")

myTracts <- c("42101015800", "42101014300", "42101037800","42101016000")
...
acsTractsPHL.2019.sf <- get_acs(geography = "tract",
  ...
  dplyr::rename (total_pop.2019=`B01003_001E`, black_pop.2019 = `B01001B_001E`, novehicle_HH.2019 = `B08201_002E`) %>%
  mutate(pct_black.2019=black_pop.2019/total_pop.2019)%>%
...
ggplot()+
  geom_sf(data = acsTractsPHL.2019.sf, aes(fill = pct_black.2019),
          color = "transparent")+
  geom_sf(data = acsTractsPHL.2019.sf %>%
            filter(Neighborhood == "fishtown") %>%
            st_union(),
          color = "white",
          fill = "transparent")+
  ...
  labs(
    title = "Black Population in Philadelphia",
    subtitle = "Fishtown Neighborhood",
    caption = "Data: U.S. Census Bureau, 2019ACS")
